...
export function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Error is handled by login toast, but we catch here to stop loading state
    ...
    <div className="min-h-screen bg-[#FFFFF0] flex items-center justify-center p-4 font-['Poppins']">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-[#1a3a10] mb-2">Welcome Back</h1>
          <p className="text-[#4a6a35]">Sign in to continue monitoring</p>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-white text-[#4a6a35]">Or continue with email</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-[#28951B] focus:ring-[#28951B]" />
              <span className="text-[#4a6a35]">Remember me</span>
            </label>
            <a href="#" className="text-[#28951B] font-medium hover:underline">Forgot password?</a>
          </div>
        ...
        <div className="mt-8 text-center text-sm text-[#4a6a35]">
          ...
          <Link to="/register" className="text-[#28951B] font-bold hover:underline">
            Create Account
          </Link>
        </div>
      </motion.div>
