// ESP32 Greenhouse Simulator - Web Wokwi Version
...
// Pin Configuration untuk visual components
#define DHT_PIN 4
#define LED_R_PIN 25
#define LED_G_PIN 26
#define LED_B_PIN 27
...
void updateVisuals() {
  ...
  // This will be visible in the Wokwi visual interface
  Serial.println("Visual components updated");
}
